...
func NewCdkParameterStoreTestStack(scope constructs.Construct, id string, props *CdkParameterStoreTestStackProps) awscdk.Stack {
...
func main() {
	...
	NewCdkParameterStoreTestStack(app, "CdkParameterStoreTestStack", &CdkParameterStoreTestStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
